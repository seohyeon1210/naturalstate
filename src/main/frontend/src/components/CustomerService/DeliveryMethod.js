    ...
    <div className="delivery-method-container">
      ...
      <div className="delivery-section">
        ...
        <ul className="delivery-list">
          ...
          <li>
            마법배송 프로그램은 평일/주말 관계없이 실시간으로 주문서가 수집되는 시스템으로, 주문 후
            취소 및 배송지 변경 등이 불가할 수 있습니다.
          </li>
          <li>
          ...
          <li>
            ...
            <br />
            * 문의 가능 시간: 월~금 오전 10시~오후 5시 (공휴일 제외)
          </li>
          <li>
            주문 접수 후 3일 이내에 입금이 확인되지 않는 경우 자동으로 주문취소가 됩니다.
          </li>
          <li>사은품 변경 및 샘플 임의 추가는 어려운 점 양해 부탁드립니다.</li>
        </ul>
      </div>
    </div>
  );
